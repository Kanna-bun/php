    ...
    $resultat1 += 3; // $resultat1 vaut 10
    $resultat1++; //$resultat1 vaut 11 et renvoie 10
    echo $resultat1.'<br />';
    ...
    $credit = 1000; // On a un crédit sur un compte
    $manque = 500 - $credit;

    // -Avec un crédit de 1000 ou plus, on a accès au premium
    // -Avec un crédit de 500 ou plus, on a accès au standard
    // -Avec moins de 500, on dit à l'utilisateur combien il lui manque pour arriver à 500
    ...
    // -&& (and)
    // -|| (or) Le symbole Pipe avec alt gr 6
