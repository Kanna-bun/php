...
<body>
    ...
    // On peut utiliser les doubles et / ou échapper les quotes avec un \
        ...
        $price = 2.99; // Un float (un nombre à virgule)
        $monkeyEatBanana = true; // Un boolean (Booléen vrai ou faux)

        // La concaténation, c'est mettre bout à bout plusieurs chaines de caractères et / ou variables.
        echo 'J\'ai '.$age.' ans et je vis à '.$city.'.<br />';
